export function About() {
    const stats = [
      { value: '10K+', label: 'Happy Clients', width: '120' },
      { value: '$500M+', label: 'Loans Approved', width: '199' },
      { value: '15+', label: 'Years Experience', width: '147' },
    ];
            ...
            <div className="flex w-full flex-col gap-6 sm:gap-8 md:gap-10 lg:w-[48%] lg:max-w-[560px]">
              <div className="flex flex-col gap-4 sm:gap-5 md:gap-6">
                ...
                <p className="font-body text-[16px] font-light leading-[26px] text-(--color-black-grey) sm:text-[17px] sm:leading-[28px] md:text-[18px] md:leading-[30px]">
                  At American Finance Experts, we provide transparent, reliable, and customized financial solutions tailored to your unique goals. For more than a decade, we&apos;ve helped individuals, families, and businesses make confident decisions about loans, insurance, investments, retirement planning, and long-term wealth building.
                </p>
              </div>
            </div>
