        ...
        <div className="flex flex-col gap-8 sm:gap-10 md:gap-12">
          <div className="flex flex-col gap-4">
            ...
            <p className="font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:text-[16px] sm:leading-[28px]">
              At American Finance Experts, we collect information that you provide directly to us, such as when you:
            </p>
            <ul className="ml-6 flex flex-col gap-2 font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:ml-8 sm:text-[16px] sm:leading-[28px]">
              <li className="list-disc">Apply for loans or financial services</li>
            ...
            <ul className="ml-6 flex flex-col gap-2 font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:ml-8 sm:text-[16px] sm:leading-[28px]">
              ...
              <li className="list-disc">Financial information (income, employment details, credit history)</li>
              <li className="list-disc">Identity verification documents</li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="ml-6 flex flex-col gap-2 font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:ml-8 sm:text-[16px] sm:leading-[28px]">
              <li className="list-disc">Process loan applications and provide financial services</li>
              <li className="list-disc">Verify your identity and assess creditworthiness</li>
              <li className="list-disc">Communicate with you about our services</li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="ml-6 flex flex-col gap-2 font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:ml-8 sm:text-[16px] sm:leading-[28px]">
              <li className="list-disc">Lending partners and financial institutions</li>
              <li className="list-disc">Credit bureaus and verification services</li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:text-[16px] sm:leading-[28px]">
              If you have any questions about this Privacy Policy or our data practices, please <button onClick={() => openModal('contact')} className="text-(--color-blue) underline">Contact Us</button>
            </p>
          </div>
